...
// Center the visible artwork, which is not consistently centered in the source PNG canvas.
const SKILL_ICON_TRANSFORMS: Readonly<Record<string, string>> = {
  'arcane-cleave': 'translate(0%, 0.6%)',
  'twin-phantom': 'translate(0.2%, 0%)',
  'rune-step': 'translate(2.1%, 0%)',
  'astral-counter': 'translate(-0.2%, -0.2%)',
  'constellation-storm': 'translate(-0.6%, 1.8%)',
  'gale-arrow': 'translate(-3.5%, -1.2%)',
  'split-shot': 'translate(-3.9%, 0.2%)',
  'verdant-snare': 'translate(-0.4%, -0.6%)',
  'feather-step': 'translate(3.1%, -1.2%)',
  'emerald-rain': 'translate(6.4%, 0%)',
  'crescent-fang': 'translate(-2%, -2.1%)',
  'phantom-cross': 'translate(-0.2%, -3.5%)',
  'shadow-reversal': 'translate(2.5%, -5.5%)',
  'azure-focus': 'translate(-2.7%, -3.5%)',
  'infinite-blades': 'translate(-0.8%, -3.7%)',
  'iron-jab': 'translate(-0.8%, -1%)',
  'hundred-fists': 'translate(-0.2%, 1.2%)',
  'titan-fist': 'translate(0.6%, 0.6%)',
  'burning-spirit': 'translate(-1.4%, 4.9%)',
  'heaven-breaker': 'translate(-0.2%, 4.1%)',
  'draconic-thrust': 'translate(-1%, -1%)',
  wingbreaker: 'translate(0%, -1%)',
  'inferno-breath': 'translate(1.4%, -1.2%)',
  dragonheart: 'translate(-1.2%, 0.8%)',
  'cataclysm-wyvern': 'translate(0%, 0.8%)',
  quickdraw: 'translate(3.3%, -8.2%)',
  'scatter-burst': 'translate(-0.2%, 1.2%)',
  'ricochet-round': 'translate(1%, 2.5%)',
  deadeye: 'translate(2.1%, 3.1%)',
  'bullet-tempest': 'translate(0.6%, 2%)',
  'moonlit-draw': 'translate(-7.2%, -4.3%)',
  'tiger-step': 'translate(1.4%, -4.1%)',
  'crimson-formation': 'translate(9.6%, -2.9%)',
  'unbroken-resolve': 'translate(-7.2%, 5.7%)',
  'heaven-sever': 'translate(0.6%, 6.6%)',
  'gale-kick': 'translate(-3.3%, 0%)',
  'rising-dragon': 'translate(-1.2%, 0.4%)',
  'cyclone-heel': 'translate(4.1%, 0%)',
  'flow-state': 'translate(-3.5%, 1%)',
  'skybreaker-combo': 'translate(0.2%, 1%)',
  'venom-needle': 'translate(-6.8%, 0.4%)',
  'plague-pool': 'translate(0.6%, -2%)',
  'serpent-miasma': 'translate(8.8%, -1.4%)',
  'antidote-pact': 'translate(-3.3%, 5.7%)',
  deathbloom: 'translate(1.2%, 4.1%)',
  'ember-lance': 'translate(-7.6%, -1.4%)',
  'flame-pillar': 'translate(0%, 2%)',
  'phoenix-spiral': 'translate(6.8%, -0.8%)',
  'burning-soul': 'translate(-4.5%, 6.6%)',
  'solar-cataclysm': 'translate(0%, 6.3%)',
  'iron-crash': 'translate(-2.1%, -1%)',
  'seismic-march': 'translate(0.6%, -2%)',
  'gravity-bell': 'translate(6.1%, -3.5%)',
  'adamant-guard': 'translate(-4.5%, 4.9%)',
  'world-anvil': 'translate(0.4%, 3.5%)',
  'rending-arc': 'translate(-0.2%, -2.3%)',
  'predator-rush': 'translate(2.3%, -4.3%)',
  'blood-cyclone': 'translate(5.1%, -2.9%)',
  ...
  return (
    <section className="mb-4 border border-[#5d684d] bg-[#171c14] p-4">
      ...
      <div className={`mt-3 flex flex-col items-center justify-between gap-5 border-2 bg-[#211b12] p-4 text-center sm:flex-row sm:text-left ${usesPurpleArmorFrame ? 'border-[#9b63d4] shadow-[inset_0_0_24px_rgba(139,92,246,.14),0_0_14px_rgba(139,92,246,.16)]' : 'border-[#9a7b45] shadow-[inset_0_0_22px_rgba(208,180,122,.10)]'}`}>
        <div className="flex flex-col items-center gap-4 sm:flex-row"><div className={`relative size-20 shrink-0 overflow-hidden rounded-xl border-2 bg-black transition-all duration-300 ${armorFrameClass} ${armorLevel >= 3 ? 'armor-max-shimmer' : ''}`}><Image src={`/assets/armor-tiers/armor-${armorLevel}.png`} alt={`Aegis Armor enhancement level ${armorLevel}`} width={80} height={80} unoptimized className={`size-full rounded-lg border-2 object-contain ${armorFrameClass} ${armorLevel >= 3 ? 'armor-max-shimmer__icon' : ''}`}/></div><div><span className="text-[10px] font-bold tracking-[.18em] text-[#d0b47a]">SEPARATE ARMOR FORGE · +{armorLevel}/5</span><strong className="mt-2 block font-extrabold text-[#f0dfbd]">{aegisArmor.name}</strong><p className="mt-1 text-xs font-medium text-[#a99c87]">Evolves separately from character upgrades. Each level improves armor power and its exclusive particles.</p></div></div>
