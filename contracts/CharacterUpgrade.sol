...
contract CharacterUpgrade is AccessControl {
    ...
    function priceFor(UpgradeType upgradeType, uint8 currentLevel) public pure returns (uint256) {
        ...
        uint256 basePrice = upgradeType == UpgradeType.Attack ? 30 ether : upgradeType == UpgradeType.Vitality ? 25 ether : 35 ether;
